...
export default function Card({ title, category, image, id, price }) {
  return (
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 shadow-xl transition hover:bg-[length:400%_400%] my-5">
     <Link href={`/products/${id}`}>
      ...
      <div class="px-5 pb-5">
        ...
        <div class="flex items-center mt-2.5 mb-5">
          ...
          <span class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">{category}</span>
        </div>
